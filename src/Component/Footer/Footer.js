...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="px-4 divide-y mt-10 dark:bg-gray-800 dark:text-gray-100">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <Link rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-red-400">
                            ...
                            <span className="self-center text-2xl font-semibold">SA Academy</span>
                        </Link>
                    </div>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-400">© Kamrul Sakil 2022. All rights reserved.</div>
            </footer>
